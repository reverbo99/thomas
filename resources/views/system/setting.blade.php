        ...
        <form action="{{ route('setting.update') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="parcel_commission_percentage" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">{{ __('system.settings.parcel_commission_percentage') }}</label>
                        <div class="relative rounded-md shadow-sm">
                            <input style="padding-left: 30px;" type="number" id="parcel_commission_percentage" name="parcel_commission_percentage" value="{{ old('parcel_commission_percentage', $settings->parcel_commission_percentage ?? 0) }}" step="0.01" min="0" max="100" required
                                   class="focus:ring-blue-500 focus:border-blue-500 block w-full pr-12 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-md" placeholder="0.00">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 dark:text-gray-400 sm:text-sm">%</span>
                            </div>
                        </div>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('system.settings.parcel_commission_percentage_desc') }}</p>
                        @error('parcel_commission_percentage')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>

                    <!-- Parcel Vendor Commission Percentage -->
                    <div>
                        <label for="parcel_vendor_commission_percentage" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">{{ __('system.settings.parcel_vendor_commission_percentage') }}</label>
                        <div class="relative rounded-md shadow-sm">
                            <input style="padding-left: 30px;" type="number" id="parcel_vendor_commission_percentage" name="parcel_vendor_commission_percentage" value="{{ old('parcel_vendor_commission_percentage', $settings->parcel_vendor_commission_percentage ?? 25) }}" step="0.01" min="0" max="100" required
                                   class="focus:ring-blue-500 focus:border-blue-500 block w-full pr-12 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-md" placeholder="25.00">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 dark:text-gray-400 sm:text-sm">%</span>
                            </div>
                        </div>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('system.settings.parcel_vendor_commission_percentage_desc') }}</p>
                        @error('parcel_vendor_commission_percentage')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
