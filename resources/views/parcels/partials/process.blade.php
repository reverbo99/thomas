...
<div class="grid gap-6 lg:grid-cols-2">
    <div class="rounded-xl border bg-white p-5 shadow-sm space-y-2 text-sm">
        ...
        <p><strong>{{ __('vender/parcels.receiver_delivery_address') }}:</strong> {{ $parcel->receiver_delivery_address }}</p>
        <p><strong>{{ __('vender/parcels.parcel_instructions') }}:</strong> {{ $parcel->parcel_instructions }}</p>
